...
CREATE TABLE IF NOT EXISTS `queries` (
  ...
  `queryid` int(32) NOT NULL DEFAULT '0',
  `jsonQuery` longtext COLLATE utf8_unicode_ci NOT NULL,
  `sparqlQuery` text COLLATE utf8_unicode_ci NOT NULL,
  `sparqlEndpoint` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `jsonResult` longtext COLLATE utf8_unicode_ci NOT NULL,
  `launchTime` datetime NOT NULL,
  `endTime` datetime NOT NULL,
  `Status` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`sessionid`,`queryid`),
  KEY `sparqlEndpoint` (`sparqlEndpoint`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
